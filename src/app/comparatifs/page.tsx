...
export const metadata = {
  title: "Comparatifs Voyage — Agences et offres | Vacances Bons Plans",
  description:
    "Comparatifs des meilleures agences de voyage en ligne : Cdiscount vs Leclerc vs Auchan vs Havas. Prix, services, avis.",
};

export default function ComparatifPage() {
  const articles = getArticlesByCategory("comparatif");
    ...
    <div className="py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-lg text-slate-500 mb-10">
          Comparatifs detailles des agences de voyage en ligne, offres et
          services.
        </p>
