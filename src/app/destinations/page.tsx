...
export const metadata = {
  title: "Destinations voyage — Guides complets | Vacances Bons Plans",
  description:
    "Decouvrez nos guides destinations : ou partir, que faire, meilleurs sejours. Europe, Afrique, Asie, Ameriques.",
};

export default function DestinationsPage() {
  const articles = getArticlesByCategory("destination");
    ...
    <div className="py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-lg text-slate-500 mb-10">
          Guides complets par destination : que faire, ou dormir, quand partir
          et les meilleurs sejours.
        </p>
